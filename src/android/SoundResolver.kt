 ...
 *  2. The app's web assets — `assets/www/` (Cordova) and `assets/public/`
 *     (Capacitor) — matching the exact filename or the hashed `<base>__<hash>.<ext>`
...
internal object SoundResolver {
    ...
    private val ASSET_FOLDERS = arrayOf("www", "public")
